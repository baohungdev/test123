...
<body>
    ...
    <div class="container">
        ...
        <div class="main" style="border: 1px solid black;">
            <div class="s1" style="border: 1px solid black;">
                <p style="border: 1px solid black;">Subjects</p>
                <p style="border: 1px solid black;">Paper 11</p>
                <p style="border: 1px solid black;">Paper 2</p>
                <p style="border: 1px solid black;">Paper 3</p>
                <p style="border: 1px solid black;">Paper 4</p>
                <p style="border: 1px solid black;">Paper 5</p>
            </div>
            <div class="s2">
                <p>Marks</p>
                <?php echo '<p>'.$p1.'</p>';?>
        ...
        <div class="result">
            ...
            <?php echo '<p>Average:&nbsp'.$percentage.'</p>';?>
        </div>
