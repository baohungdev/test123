...
<body>
    ...
    <div class="title">
        <a href="dashboard.php"><img src="" alt="" class="logo"></a>
    ...
    <div class="main">
        ...
        <form action="" method="post">
            <fieldset>
                ...
                <input type="text" name="p2" id="" placeholder="EC003">
                <input type="text" name="p3" id="" placeholder="IS334">
                <input type="text" name="p4" id="" placeholder="MA005">
                <input type="text" name="p5" id="" placeholder="MA004">
